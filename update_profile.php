...
$sql = 'UPDATE user SET name ="'. $newProfile['name'] .'", email="'. $newProfile['email'] .'", date="'. $newProfile['date'] .'", gender="'. $newProfile['gender'] .'", status="'. $newProfile['status'] .'", bio="'. $newProfile['bio'] .'" WHERE id='.$user;
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center">
        <div class="container">
          ...
          <p class="lead text-muted">Your profile was updated</p>
          <p>
